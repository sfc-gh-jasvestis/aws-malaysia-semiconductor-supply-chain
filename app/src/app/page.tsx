  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="On-Time Delivery" value={kpiVal('On-Time Delivery', '94%')} status="warning" />
        <KPICard title="Component Shortage" value={kpiVal('Component Shortage', '8 SKUs')} status="danger" />
        <KPICard title="Lead Time (Avg)" value={kpiVal('Lead Time (Avg)', '6.2 weeks')} status="neutral" />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className="lg:col-span-1 grid grid-cols-1 gap-4">
          <Chart data={data?.timeseries || [{ period: 'Jan', value: 112 }, { period: 'Feb', value: 118 }, { period: 'Mar', value: 135 }, { period: 'Apr', value: 148 }, { period: 'May', value: 156 }, { period: 'Jun', value: 142 }, { period: 'Jul', value: 138 }, { period: 'Aug', value: 151 }, { period: 'Sep', value: 144 }, { period: 'Oct', value: 132 }, { period: 'Nov', value: 121 }, { period: 'Dec', value: 115 }]} type="line" xKey="period" yKeys={[{ key: 'value', name: 'OTD %' }]} title="Delivery Performance (Weekly)" />
          <Chart data={data?.categoryMetric || [{ category: 'North', count: 82 }, { category: 'Central', count: 74 }, { category: 'South', count: 91 }, { category: 'Highland', count: 68 }, { category: 'Coastal', count: 77 }]} type="bar" xKey="category" yKeys={[{ key: 'count', name: 'SKUs' }]} title="Shortage by Component Type" />
        </div>
      </div>
      <DataTable columns={[
          { key: 'id', header: 'Rank' },
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="Single-Source Risk" value={kpiVal('Single-Source Risk', 'RM 42M')} />
        <KPICard title="Buffer Stock" value={kpiVal('Buffer Stock', '8 days')} />
        <KPICard title="Alternatives" value={kpiVal('Alternatives', '84%')} />
      </div>
